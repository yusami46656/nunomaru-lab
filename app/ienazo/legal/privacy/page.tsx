...
const SECTIONS: { h: string; body: React.ReactNode }[] = [
  ...
  {
    h: "第2条（取得する情報）",
    body: "当方は、本サービスの提供にあたり、次の情報を取得します。①アカウント登録時のメールアドレス、②外部サービス（Google、LINE、X）によるログインをご利用の場合、当該サービスから提供される識別子・表示名・プロフィール画像・メールアドレス（提供される場合に限る）、③有料作品の購入・利用履歴および進捗データ、④お問い合わせの際にご提供いただく情報、⑤アクセス解析・広告配信に伴う Cookie 等の情報。外部サービスのパスワードを当方が取得することはありません。また、クレジットカード番号等の決済情報は決済代行事業者（Stripe）が取得・管理し、当方は保持しません。",
  },
  {
    h: "第3条（利用目的）",
  ...
  {
    h: "第4条（第三者提供・委託）",
    body: "当方は、法令に基づく場合を除き、ご本人の同意なく個人情報を第三者に提供しません。ただし、決済処理のため Stripe（Stripe, Inc. および関連会社）へ、認証・データ保管のため当方が利用するクラウドサービスへ、必要な範囲で取扱いを委託します。外部サービスによるログインをご利用の場合、認証のために必要な範囲で当該サービス（Google LLC、LINEヤフー株式会社、X Corp.）との間で情報のやり取りが発生します。これらの事業者は各社のプライバシーポリシーに基づき情報を管理します。",
  },
  {
    h: "第5条（決済について）",
