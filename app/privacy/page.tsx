...
export const metadata: Metadata = {
  ...
  description:
    "ぬのまるの実験工房におけるアクセス解析・広告配信・Cookieの利用方針について記載したプライバシーポリシーです。",
};
  ...
  return (
    <article className="space-y-8">
      ...
      <section className="space-y-3">
        <h2 className="nl-heading-serif text-xl font-bold">1. 個人情報の取り扱いについて</h2>
        <p className="text-sm leading-relaxed text-ink-800">
          ぬのまるの実験工房(以下「当サイト」)は、利用者の個人情報の重要性を認識し、適切に取り扱うよう努めます。当サイトは原則として、利用者の氏名・住所・電話番号・メールアドレス等の個人情報を取得することはありません。
        </p>
      </section>

      <section className="space-y-3">
        <h2 className="nl-heading-serif text-xl font-bold">2. アクセス解析ツールについて</h2>
        <p className="text-sm leading-relaxed text-ink-800">
      ...
      <section className="space-y-3">
        <h2 className="nl-heading-serif text-xl font-bold">3. 広告配信について</h2>
        <p className="text-sm leading-relaxed text-ink-800">
      ...
      <section className="space-y-3">
        <h2 className="nl-heading-serif text-xl font-bold">4. Cookie について</h2>
        <p className="text-sm leading-relaxed text-ink-800">
      ...
      <section className="space-y-3">
        <h2 className="nl-heading-serif text-xl font-bold">5. 免責事項</h2>
        <p className="text-sm leading-relaxed text-ink-800">
      ...
      <section className="space-y-3">
        <h2 className="nl-heading-serif text-xl font-bold">6. プライバシーポリシーの変更</h2>
        <p className="text-sm leading-relaxed text-ink-800">
