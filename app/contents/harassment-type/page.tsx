    ...
    <div className="space-y-12">
      ...
      >
        ...
        <div className="relative sm:hidden">
          <Image
            src="/contents/harassment-type/hero/hero_phone.png"
            alt=""
            width={1080}
            height={1440}
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-start pt-[2%] text-center">
            ...
            <div className="mt-2 flex flex-col items-center gap-1 w-full px-4">
              ...
              <div className="mt-2 flex flex-col gap-2 w-full max-w-xs">
                <Link
                  href="/contents/harassment-type/questions"
                ...
                <Link
                  href="/contents/harassment-type/types"
        ...
        <div className="relative hidden sm:block">
          <Image
            src="/contents/harassment-type/hero/hero_pc.png"
            alt=""
            width={1920}
            height={794}
            className="w-full h-auto block"
