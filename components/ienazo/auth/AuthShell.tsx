  ...
  return (
    ...
    <div className="bg-ienazo-paper">
      ...
      <div className="mx-auto flex min-h-[calc(100svh-4rem)] w-full max-w-4xl items-center px-4 py-5 sm:px-6 sm:py-14 lg:py-20">
        {/* Reveal（スクロールで現れる演出）は使わない。このカードはページ唯一の中身で、
            初期表示から画面内にある。視界に入るまで出さない作りにすると、
            ハイドレーションが終わるまでフォームが空白になるだけになる。
            w-full は Reveal が持っていたものをここへ移した（親が flex のため必要）。 */}
        <div className="grid w-full overflow-hidden border border-ienazo-rule bg-ienazo-paper-soft shadow-ienazo-card md:grid-cols-[0.85fr_1fr]">
